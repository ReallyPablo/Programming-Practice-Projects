...
**Padding** — дірки в struct заради вирівнювання. **Bump-алокатор** (bump allocator) — «відріж n байтів від вершини купи, вершину посунь»; `free` немає. **Dangling** — вказівник живий, об’єкт уже ні. **Витік** — об’єкт живий, вказівника вже ні.
...
- Де на [карті пам’яті](ISA.uk.md#2-карта-памяті) купа й стек? Куди росте кожен?

---

## Якщо мало часу

§1, §3, два спрайти на екрані. Купа всередині ember — Stretch, якщо лишився час.
