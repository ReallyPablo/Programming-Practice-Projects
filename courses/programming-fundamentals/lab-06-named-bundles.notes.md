...
**Padding** — дірки в struct заради вирівнювання. **Bump allocator** — «відріж n байт від вершини купи, вершину посунь»; `free` немає. **Дdangling** — вказівник живий, об’єкт уже ні. **Витік** — об’єкт живий, вказівника вже ні.
...
«Іменований тип» зі старих лаб — це `Sprite { x, y, vx, vy, alive }`, не «відсоток відмінників 1 курсу».
...
Подвійний `delete p; delete p;` — інший репорт. Третій моральний: не роби так.
...
Host `new` — щоб sanitizer навчив. Guest `alloc` — щоб VM мала купу.
...
§1, §3, два спрайти на екрані. Купа гостя — з лаби M3.
