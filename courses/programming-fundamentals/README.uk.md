...
У лабах ця програма називається **`ember`**. Це не готова бібліотека і не нова мова — це те, що ви пишете. Назва одна, щоб не плутатись між файлами. Свій проєкт можна назвати як завгодно. Тема теж ваша: бортовий комп’ютер, приставка, калькулятор.
...
Усі збирають схожу машину. Відрізняється тема, зайві інструкції, програми, які ви для неї напишете, і README.
