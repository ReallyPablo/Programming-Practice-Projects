...
| **VRAM** | 256 байтів пам’яті `ember`, з яких зроблено екран. Не окремий масив — [ISA.uk.md §7](ISA.uk.md#7-екран-це-память). |
...
1. **Про що ця лаба** — що саме ви з неї берете і навіщо воно потім.
2. **Notes** — коротка теорія, фрагменти коду, очікуваний вивід. На парі чи вдома. Лабу не замінює.
3. **Теорія** — як це влаштовано, типові помилки, досліди. Це читання.
4. **Крок проєкту** — що додати в `ember`, етапи і коли вважати готовим.
5. **Рівні** — Basic / Standard / Advanced з чесною оцінкою годин. Оберіть рівень **до** початку: Basic — це нормально здана лаба, а не провал.
6. **Чекліст здачі**.
7. **На захисті** — питання до дошки.
8. **Якщо встигаєте** — необов'язкове, коли йдете з випередженням.
9. **Що почитати й подивитись** — кілька відео й текстів, біля кожного рядок, навіщо саме це.
