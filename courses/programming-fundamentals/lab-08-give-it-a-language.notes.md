...
Лаба — **що здати** (лексер, asm, чотири програми, `v1.0.0`). Цей файл — **з чим розібратись**. Лексер і програми — `./build/ember lex …` та `./build/ember programs/fib.asm`. Дрібні C++-досліди — `scratch.cpp` як у [Notes 01](lab-01-a-box-of-bytes.notes.md).
