...
Екран — сітка пікселів. Формула та сама, що для будь-якої таблиці в пам’яті.
...
Рамка з C++ (чотири цикли) — перший раз бачиш екран. Три пікселі з програми всередині ember — доказ, що опкод живий.
