...
Graceful shutdown: на `SIGTERM` перестати приймати нове, дослати close-кадри, вийти 0 за кілька секунд. Інакше оркестратор шле `SIGKILL`.
...
**Очікуй:** браузер заблокує. Прод = `wss://`. Локально http+ws ок.
